...
public class VideoChatActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        button = (Button)findViewById(R.id.switchcamera);
    ...
    public void doStart() {
        ...
        if (mCamera == null) {
            ...
            parameters.setPreviewFormat(PixelFormat.YCbCr_420_SP); //设置预览视频的格式
...
//            parameters.setPreviewSize(size.width, size.height);
            ...
            parameters.setPreviewSize(352, 288); //设置预览视频的尺寸，CIF格式352×288
            //p.setPreviewSize(800, 600);
            parameters.setPreviewFrameRate(15); //设置预览的帧率，15帧/秒

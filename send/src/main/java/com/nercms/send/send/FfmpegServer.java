package com.nercms.send.send;

import android.content.Context;
import android.util.Log;

import com.nercms.send.Config;
import com.nercms.send.LogUtil;
    ...
    class DecoderThread extends Thread {
        public void run() {
            ...
            while (isRunning) {
                ...
                LogUtil.d(Config.TAG, "接收  sequence:" + sequence +"总长度："+rtp_receive_packet.getLength()+ " 包长度:" + data.length+"  "+rtp_receive_packet.getPayloadLength()+" "+ Arrays.toString(data));
